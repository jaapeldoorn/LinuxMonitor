    ...
    <section class="controls">
      <label>Time window:
        <select id="range">
          ...
          <option value="360" <?= $config['app']['default_minutes'] == 360 ? 'selected' : '' ?>>6 hours</option>
          <option value="1440" <?= $config['app']['default_minutes'] == 1440 ? 'selected' : '' ?>>1 day</option>
          <option value="10080" <?= $config['app']['default_minutes'] == 10080 ? 'selected' : '' ?>>1 week</option>
        </select>
      </label>
      <label>Server:
        <select id="device">
