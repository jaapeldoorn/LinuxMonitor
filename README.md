![GitHub Release](https://img.shields.io/github/v/release/jaapeldoorn/LinuxMonitor) ![GitHub Release Date](https://img.shields.io/github/release-date/jaapeldoorn/LinuxMonitor) ![GitHub last commit](https://img.shields.io/github/last-commit/jaapeldoorn/LinuxMonitor) ![GitHub Repo stars](https://img.shields.io/github/stars/jaapeldoorn/LinuxMonitor?style=flat) ![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/jaapeldoorn/LinuxMonitor/total) 
